...
To test whether we can combine the movie and plot, we start by combining the first frame and verify the result:
...
```{r}
image_write_gif(combined_gif[49], 'Protocol_18.png')
```
